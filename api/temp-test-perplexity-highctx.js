// TEMPORARY — testing whether web_search_options.search_context_size:"high"
// reduces the hallucinated/dead-domain rate measured earlier (7 of 12 URLs
// dead at the default "low" context size). Delete after the comparison.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({ stores, elapsedMs, usage: data.usage })
  } catch (err) {
